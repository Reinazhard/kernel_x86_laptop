...
struct cfs_rq {
	...
	UEK_KABI_RENAME(unsigned int h_nr_running, unsigned int h_nr_queued);
	...
	UEK_KABI_RENAME(u64 min_vruntime, u64	zero_vruntime);
#ifdef CONFIG_SCHED_CORE
	unsigned int		forceidle_seq;
	UEK_KABI_RENAME(u64 min_vruntime_fi, u64	zero_vruntime_fi);
#endif
